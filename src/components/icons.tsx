...
export function TilosLogo({
  ...
  return (
    <div className={`bg-main hover:bg-accent flex items-center border border-border transition-colors rounded-full px-2 py-0 ${className}`}>
...
export function HeartIcon({
  ...
  return (
    <svg
      ...
      className={`h-5 w-5 ${
        filled ? "fill-current text-red-500" : "text-current"
      } ${className}`}
      viewBox="0 0 20 20"
